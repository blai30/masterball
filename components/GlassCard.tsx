...
const variants = cva({
  base: 'rounded-l-sm rounded-tr-sm rounded-br-xl bg-gradient-to-br from-zinc-50 to-zinc-100 to-75% inset-ring-1 inset-ring-zinc-200 dark:from-zinc-900 dark:to-zinc-950 dark:inset-ring-zinc-800',
  variants: {
    variant: {
      default: '',
