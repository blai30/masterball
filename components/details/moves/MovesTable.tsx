          ...
          {moves.map((move) => {
            ...
            return (
              <li
                key={resource.id}
                className={clsx(
                  'group inline-flex h-10 min-w-full flex-row items-center',
                  'rounded-md',
