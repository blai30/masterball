...
import { getEffectiveness, TypeKey, type TypeRelation } from '@/lib/utils/pokeapi-helpers'
import TypePill from '@/components/TypePill'
import EffectivenessMultiplier from '@/components/details/typeEffectiveness/EffectivenessMultiplier'

export default async function TypeEffectivenessSection({ pokemon }: { pokemon: Pokemon }) {
