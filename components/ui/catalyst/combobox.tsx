...
export function Combobox<T>({
  ...
  options: T[]
  displayValueAction: (value: T | null) => string | undefined
  filter?: (value: T, query: string) => boolean
  className?: string
  placeholder?: string
  autoFocus?: boolean
  'aria-label'?: string
  childrenAction: (value: NonNullable<T>) => React.ReactElement
    ...
    >
      ...
      >
        <Headless.ComboboxInput
          ...
          data-slot="control"
          aria-label={ariaLabel}
          displayValue={(option: T) => displayValueAction(option) ?? ''}
